...
extern Int64  Blind_sort_ratio;        // ratio for using blind_sort
extern Int64 Calls_deep_sort;     
...
void qs_unrolled_lcp(Int64 *a, Int64 n, Int64 depth, Int64 blind_limit) // 64 bit version
{ 
  //void blind_ssort(Int32 *a, Int32 n, Int32 depth);
  void blind_ssort(Int64 *, Int64 , Int64 ); // 64 bit version
  ...
  Int64 stack_lo[STACK_SIZE];
  Int64 stack_hi[STACK_SIZE];
  Int64 stack_d[STACK_SIZE];
  Int64 sp,r,r3,med,tmp;
  Int64 i, j, lo, hi,ris,lcp_lo,lcp_hi;
...
void deep_sort(Int64 *a, Int64 n, Int64 depth) //64 bit version
{
  void blind_ssort(Int64 *, Int64 , Int64 );
  //int blind_limit;
  Int64 blind_limit;
